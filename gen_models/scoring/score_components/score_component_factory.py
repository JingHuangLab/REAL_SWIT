...
from scoring.score_components.cdock_score import CDockScore
from scoring.score_components.max_linker_length import MaxLinkerLength
from scoring.score_components.max_tail_length import MaxTailLength
from scoring.score_components.ligand_efficiency import LigandEfficiency
from scoring.score_components.num_heavy_atoms import HeavyAtomScore
...
class ScoreComponentFactory:
    ...
    def _default_scoring_component_registry(self) -> dict:
        ...
        component_map = {
            ...
            enum.MaxLinkerLength:MaxLinkerLength,
            enum.MaxTailLength:MaxTailLength,
            enum.HeavyAtomScore:HeavyAtomScore,
            enum.LigandEfficiency:LigandEfficiency
        }
