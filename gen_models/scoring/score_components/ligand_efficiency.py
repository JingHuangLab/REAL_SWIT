...
class LigandEfficiency(BaseScoreComponent):
    ...
    def calculate_score(self, molecules: List) -> ComponentSummary:
        ...
        for m in molecules:
            ...
            nheavy_lst.append(n_heavy)
        #try:    
        score_pre = self.predict(self.activity_model, smi_lst, scaler=self.scaler,batch_size=len(smi_lst)) 
        #print(f"score_pre:{score_pre}")
        score_pre=[sp*-1/nheavy_lst[idx] for idx,sp in enumerate(score_pre)]
        #print(f"score_pre:{score_pre}")
