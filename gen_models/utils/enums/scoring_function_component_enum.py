...
class ScoringFunctionComponentNameEnum():
    ...
    __SA_SCORE = "sa_score"
    __AZDOCK = "azdock"
    __CDOCK_SCORE = "cdock_score"
    __MaxLinkerLength = "MaxLinkerLength"
    __MaxTailLength = "MaxTailLength"
    __LigandEfficiency = "LigandEfficiency"
    __HeavyAtomScore = "HeavyAtomScore"
    ...
    @property
    def CDOCK_SCORE(self):
        return self.__CDOCK_SCORE

    @CDOCK_SCORE.setter
    def CDOCK_SCORE(self, value):
        raise ValueError("Do not assign value to a ScoringFunctionComponentNameEnum field")

    @property
    def MaxLinkerLength(self):
        return self.__MaxLinkerLength

    @MaxLinkerLength.setter
    def MaxLinkerLength(self, value):
        raise ValueError("Do not assign value to a ScoringFunctionComponentNameEnum field")

    @property
    def MaxTailLength(self):
        return self.__MaxTailLength

    @MaxTailLength.setter
    def MaxTailLength(self, value):
        raise ValueError("Do not assign value to a ScoringFunctionComponentNameEnum field")

    @property
    def HeavyAtomScore(self):
        return self.__HeavyAtomScore

    @HeavyAtomScore.setter
    def HeavyAtomScore(self, value):
        raise ValueError("Do not assign value to a ScoringFunctionComponentNameEnum field")
    
    @property
    def LigandEfficiency(self):
        return self.__LigandEfficiency

    @LigandEfficiency.setter
    def LigandEfficiency(self, value):
        raise ValueError("Do not assign value to a ScoringFunctionComponentNameEnum field")